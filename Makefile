...
install:
	...
	cp gswitch.conf ${DESTDIR}/usr/share/gswitch/gswitch.conf
...
uninstall:
	...
	rm -f ${DESTDIR}/etc/X11/xorg.conf.d/99-gswitch-host.conf
	rm -f ${DESTDIR}/etc/X11/xorg.conf.d/99-gswitch-host.conf.skip
	rm -f ${DESTDIR}/etc/X11/xorg.conf.d/99-gswitch-guest.conf
	rm -f ${DESTDIR}/etc/X11/xorg.conf.d/99-gswitch-guest.conf.skip
